 ...
 *   https://datatables.net/download/#dt/jq-2.1.4,dt-1.10.10,b-1.1.0,b-colvis-1.1.0,cr-1.3.0,r-2.0.0,rr-1.1.0,sc-1.4.0,se-1.1.0
 *
 * Included libraries:
 *   jQuery 2.1.4, DataTables 1.10.10, Buttons 1.1.0, Column visibility 1.1.0, ColReorder 1.3.0, Responsive 2.0.0, RowReorder 1.1.0, Scroller 1.4.0, Select 1.1.0
 */
...
(function (h) {
    ...
    m.ext = s = {buttons: {}, classes: {}, build: "dt/jq-2.1.4,dt-1.10.10,b-1.1.0,b-colvis-1.1.0,cr-1.3.0,r-2.0.0,rr-1.1.0,sc-1.4.0,se-1.1.0", errMode: "alert", feature: [], search: [], selector: {cell: [], column: [], row: []}, internal: {}, legacy: {ajax: null}, pager: {}, renderer: {pageButton: {}, header: {}}, order: {}, type: {detect: [], search: {}, order: {}}, _unique: 0, fnVersionCheck: m.fnVersionCheck, iApiIndex: 0, oJUIClasses: {}, sVersion: m.version};
...
/*
 * ! Buttons for DataTables 1.1.0 Â©2015 SpryMedia Ltd - datatables.net/license
 */
(function (e) {
...
(function (g) {
    ...
    d = g.fn.dataTable;
    g.extend(d.ext.buttons, {colvis: function (a, b) {
        ...
        columnVisibility: {columns: h, text: function (a, b, c) {
...
/*
 * ! ColReorder 1.3.0 Â©2010-2015 SpryMedia Ltd - datatables.net/license
 */
(function (f) {
    "function" === typeof define && define.amd ? define(["jquery", "datatables.net"], function (n) {
    ...
    f.fn.dataTableExt.oApi.fnColReorder = function (a, b, d, e) {
        ...
        if (b != d)
            if (0 > b || b >= i)
                ...
                c = 0;
                for (g = i; c < g; c++)
                    k = a.aoColumns[c], "number" == typeof k.mData ?
                ...
                c = 0;
                for (g = a.aoData.length; c < g; c++)
                    j = a.aoData[c], j.anCells && o(j.anCells, b, d), "dom" !== j.src && f.isArray(j._aData) && o(j._aData, b, d);
                c = 0;
                ...
                c = 0;
                for (g = i; c < g; c++)
                    f(a.aoColumns[c].nTh).off("click.DT"), this.oApi._fnSortAttachListener(a,
                            a.aoColumns[c].nTh, c);
                f(a.oInstance).trigger("column-reorder.dt", [a, {from: b, to: d, mapping: m, drop: e, iFrom: b, iTo: d, aiInvertMapping: m}])
            }
    };
    var h = function (a, b) {
        ...
        this.s = {dt: null, init: f.extend(!0, {}, h.defaults, b), fixed: 0, fixedRight: 0, reorderCallback: null, mouse: {startX: -1, startY: -1, offsetX: -1, offsetY: -1, target: -1, targetIndex: -1,
                fromIndex: -1}, aoTargets: []};
    ...
    f.extend(h.prototype, {fnReset: function () {
            ...
            if (a === r) {
                ...
                for (c = g.length; e < c; e++)
                    d.push(g[e]._ColReorder_iOrigCol);
                return d
            }
            if (b) {
                g = this.fnOrder();
            ...
            if (c)
                if (a.s.dt._bInitComplete)
                    b = p(c), a._fnOrderColumns.call(a, b);
                else {
                    var g = !1;
            ...
            if (a.aaSorting) {
                ...
                for (d = c.length; b < d; b++)
                    e = c[b]._ColReorder_iOrigCol, a.aoSearchCols[e] =
                ...
                b = 0;
                for (d = c.length; b < d; b++)
                    e = c[b]._ColReorder_iOrigCol, a.columns[e] = g[b], a.ColReorder.push(e)
            }
            ...
            if (null === this.dom.drag) {
                if (5 > Math.pow(Math.pow(a.pageX - this.s.mouse.startX, 2) + Math.pow(a.pageY -
                        this.s.mouse.startY, 2), 0.5))
                    return;
                this._fnCreateDragNode()
            }
            this.dom.drag.css({left: a.pageX - this.s.mouse.offsetX, top: a.pageY - this.s.mouse.offsetY});
            for (var b = !1, d = this.s.mouse.toIndex, e = 1, c = this.s.aoTargets.length; e < c; e++)
            ...
            for (var b = 0, d = f(a[0].nTh).offset().left, e = 0, c = a.length; e < c; e++)
            ...
            this.dom.drag = f(c.cloneNode(!1)).addClass("DTCR_clonedTable").append(f(e.cloneNode(!1)).append(f(d.cloneNode(!1)).append(g[0]))).css({position: "absolute",
                top: 0, left: 0, width: f(b).outerWidth(), height: f(b).outerHeight()}).appendTo("body");
    ...
    f.fn.DataTable.ColReorder = h;
    "function" == typeof f.fn.dataTable && "function" == typeof f.fn.dataTableExt.fnVersionCheck && f.fn.dataTableExt.fnVersionCheck("1.10.8") ? f.fn.dataTableExt.aoFeatures.push({fnInit: function (a) {
            var b = a.oInstance;
...
/*
 * ! Responsive 2.0.0 2014-2015 SpryMedia Ltd - datatables.net/license
 */
(function (c) {
    ...
    c.extend(j.prototype, {_constructor: function () {
            ...
            return c.map(this.s.columns, function (c, f) {
                if (!c.never)
                    return{title: d.settings()[0].aoColumns[f].sTitle, data: d.cell(a, f).render(b.c.orthogonal), hidden: d.column(f).visible() && !b.s.current[f]}
            })
        },
        _find: function (a) {
    ...
    j.defaults = {breakpoints: j.breakpoints, auto: !0, details: {display: j.display.childRow, renderer: function (a, b, d) {
            ...
            type: "inline"}, orthogonal: "display"};
...
/*
 * ! RowReorder 1.1.0 2015 SpryMedia Ltd - datatables.net/license
 */
(function (e) {
    ...
    var h = e.fn.dataTable, i = function (b, a) {
        ...
        this.c = e.extend(!0, {}, h.defaults.rowReorder,
                i.defaults, a);
        this.s = {bodyTop: null, dt: new h.Api(b), getDataFn: h.ext.oApi._fnGetObjectDataFn(this.c.dataSrc), middles: null, setDataFn: h.ext.oApi._fnSetObjectDataFn(this.c.dataSrc), start: {top: 0, left: 0, offsetTop: 0, offsetLeft: 0, nodes: []}, windowHeight: 0};
        this.dom = {clone: null};
    ...
    e.extend(i.prototype, {_constructor: function () {
            ...
            this._clonePosition(b);
            for (var a = this._eventToPage(b, "Y") - this.s.bodyTop, d = this.s.middles, c = null, k = this.s.dt, j = k.table().body(), f = 0, i = d.length; f < i; f++)
                if (a < d[f]) {
                    c = f;
                    break
                }
            ...
            if (null === this.s.lastInsert || this.s.lastInsert !== c)
                0 === c ? this.dom.target.prependTo(j) : (a = e.unique(k.rows({page: "current"}).nodes().toArray()), c > this.s.lastInsert ? this.dom.target.before(a[c - 1]) : this.dom.target.after(a[c])),
            ...
            if (this.c.update) {
                ...
                for (d = h.length; a < d; a++)
                    f = b.row(h[a].node).data(), p(f, h[a].newData), b.columns().every(function () {
...
/*
 * ! Scroller 1.4.0 Â©2011-2015 SpryMedia Ltd - datatables.net/license
 */
(function (e) {
    ...
    var m = e.fn.dataTable, h = function (a, b) {
        this instanceof h ? (b === l && (b = {}), this.s = {dt: e.fn.dataTable.Api(a).settings()[0], tableTop: 0, tableBottom: 0, redrawTop: 0, redrawBottom: 0, autoHeight: !0,
            viewportRows: 0, stateTO: null, drawTO: null, heights: {jump: null, page: null, virtual: null, scroll: null, row: null, viewport: null}, topRowFloat: 0, scrollDrawDiff: null, loaderVisible: !1}, this.s = e.extend(this.s, h.oDefaults, b), this.s.heights.row = this.s.rowHeight, this.dom = {force: i.createElement("div"), scroller: null, table: null, loader: null}, this.s.dt.oScroller || (this.s.dt.oScroller = this, this._fnConstruct())) : alert("Scroller warning: Scroller must be initialised with the 'new' keyword.")
    };
    e.extend(h.prototype, {fnRowToPixels: function (a,
                b, c) {
...
/*
 * ! Select for DataTables 1.1.0 2015 SpryMedia Ltd - datatables.net/license/mit
 */
(function (e) {
    ...
    e.each([{type: "row", prop: "aoData"}, {type: "column", prop: "aoColumns"}], function (c, a) {
        g.ext.selector[a.type].push(function (b,
            ...
            for (var g = 0, i = c.length; g < i; g++)
                e = b[a.prop][c[g]], (!0 === d && !0 === e._select_selected || !1 === d && !e._select_selected) && f.push(c[g]);
            return f
        })
    });
    g.ext.selector.cell.push(function (c, a, b) {
        ...
        for (var e = 0, f = b.length; e < f; e++)
            d = c.aoData[b[e].row], (!0 === a && d._selected_cells && !0 === d._selected_cells[b[e].column] || !1 === a && (!d._selected_cells || !d._selected_cells[b[e].column])) && h.push(b[e]);
        return h
    });
            ...
            if (!a._select_init) {
                ...
                a.aoRowCreatedCallback.push({fn: function (b, d, c) {
                        ...
                        for (c = a.aoColumns.length; b < c; b++)
                            (a.aoColumns[b]._select_selected || d._selected_cells && d._selected_cells[b]) && e(d.anCells[b]).addClass(a._select.className)
    ...
    e(l).on("preInit.dt.dtSelect", function (c, a) {
        if ("dt" === c.namespace) {
            ...
            if (!0 === b)
                ...
                i = b;
            else if (e.isPlainObject(b) && (b.blurable !== j && (f = b.blurable), b.info !== j && (k = b.info), b.items !== j && (h = b.items), b.style !== j && (i = b.style), b.selector !== j && (l = b.selector), b.className !== j))
                m = b.className;
            d.select.selector(l);
            d.select.items(h);
            d.select.style(i);
